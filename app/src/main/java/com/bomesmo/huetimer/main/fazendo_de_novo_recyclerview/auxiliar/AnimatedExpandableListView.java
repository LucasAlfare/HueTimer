package com.bomesmo.huetimer.main.fazendo_de_novo_recyclerview.auxiliar;
...
public class AnimatedExpandableListView extends ExpandableListView {
    ...
    public AnimatedExpandableListView(Context context) {
        super(context);
        OnGroupClickListener onGroupClickListener1 = new OnGroupClickListener() {
            @Override
        ...
        this.setOnGroupClickListener(onGroupClickListener1);
    }
